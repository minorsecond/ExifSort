...
In short, when you submit code changes, your submissions are understood to be under the same that covers the project. Feel free to contact me if that's a concern.

## Report bugs using Github's [issues](https://github.com/minorsecond/ExifSort/issues)
...
- Steps to reproduce
  - Be specific!
  - Give sample code if you can. [A good stackoverflow question](http://stackoverflow.com/q/12488905/180626) includes sample code that *anyone* with a base R setup can run to reproduce what the writer was seeing
